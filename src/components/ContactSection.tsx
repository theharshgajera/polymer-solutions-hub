        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-background rounded-2xl p-8 shadow-sm border border-border">
            <div className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-[#25D366] text-white py-3.5 rounded-lg font-body font-bold text-sm hover:bg-[#128C7E] transition-colors flex items-center justify-center gap-2 shadow-sm"
              >
